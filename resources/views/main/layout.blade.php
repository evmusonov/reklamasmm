...
<section id="tiktok" class="grayback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение в ТикТок | <span style="color: red; font-style: italic;">Новинка!</span></h3>
                <h4 class="section-title-h4">Пакет "Быстрый старт"</h4>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/tiktok.jpg">
            </div>
            <div class="col-md-6">
                <p>«ТикТок» (англ. TikTok) — социальная сеть, позволяющая создавать короткие музыкальные видео, прямые эфиры и обмениваться сообщениями. Запущенная в сентябре 2016 года, на данный момент является одной из наиболее быстрорастущих и скачиваемых социальных сетей.
                    &#128293;Поможем вам продвинутся на старте благодаря добавлению подписчиков, лайков, просмотров видео.</p>
                <p>
                <h4>Что входит в пакет?</h4>
                <ul class="ul-list">
                    <li>Подписчики - 1 тыс.чел (живые, русские);</li>
                    <li>лайки - на каждый видео по 100 шт;</li>
                    <li>Просмотры видео - 3000 чел на каждое видео.</li>
                </ul>
                </p>
                <p>От вас требуется от 10 до 20 видео на месяц. Пересылаете по электронной почте или WhatsApp.</p>
                <p>Создание и оформление аккаунта отдельная услуга - 1 т.р.</p>
                <p class="section-price">8 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
</section>
<section id="instagram" class="whiteback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Подписчики в ТикТок (живые, русские)  | <span style="color: red; font-style: italic;">Новинка!</span></h3>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/tiktok_sub.jpg">
            </div>
            <div class="col-md-6">
                <p>
                <h4>Стоимость услуги</h4>
                <p>
                    1000 чел - 1 500 руб.<br>
                    3000 чел - 4 500 руб.<br>
                    5000 чел - 7 000 руб.
                </p>
                </p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
...
<section id="instagram" class="whiteback wow fadeInUp" data-wow-delay="300ms">
    ...
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение Инстаграм</h3>
            </div>
            <div class="col-md-6 block-thumb">
            ...
            <div class="col-md-6">
                ...
                <h4>Что входит в пакет?</h4>
                <p>
                    Оформление аккаунта. Размещение постов. Размещение "Актуального" и "Сторис".
                </p>
                <p class="insta-p">
                    Продвижение в Инстаграме, привлечение целевой аудитории из нужного города.
                    За месяц подпишутся на ваш аккаунт от 500 до 1500 целевых участников, в зависимости от темы аккаунта.
                </p>
                <p class="insta-p">Создание и размещение постов.</p>
                <p class="insta-p">Дополнительная опция: рассылка сообщений в личку целевым пользователям - 1 тыс. руб./месяц.</p>
                </p>
                <p class="section-price">6 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
</section>
<section id="minimal" class="whiteback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение Вконтакте</h3>
                <h4 class="section-title-h4">Пакет "Минимум"</h4>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/vkminimal.jpg">
            </div>
            <div class="col-md-6">
                <p>
                <h4>Что входит в пакет?</h4>
                <ul class="ul-list">
                    <li>Ведение группы и поддержание ее активности.</li>
                    <li>Оптимизация настроек группы, оформление обложки.</li>
                    <li>Посты в тему группы - 1 в день.</li>
                    <li>Чистка от спама и нарушающих правила сообщений.</li>
                    <li>Проведение 1 розыгрыша.</li>
                </ul>
                </p>
                <p class="section-price">4 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
</section>
<section id="express" class="grayback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение Вконтакте</h3>
                <h4 class="section-title-h4">Пакет "Экспресс"</h4>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/vkexpress.jpg">
            </div>
            <div class="col-md-6">
                <p>
                <h4>Что входит в пакет?</h4>
                <ul class="ul-list">
                    <li>Разработка стратегии присутствия работодателя в социальных сетях.</li>
                    <li>Создание, ведение и развитие сообществ.</li>
                    <li>Ведение рекламных кампаний в соцсетях, подготовка и размещение рекламных материалов.</li>
                    <li>Поиск, создание и размещение контента (тексты, фото, видео).</li>
                    <li>Организация и проведение розыгрышей, конкурсов и опросов в группах.</li>
                    <li>Привлечение целевой аудитории, увеличение количества подписчиков, посетителей, участников групп.</li>
                </ul>
                </p>
                <p class="section-price">6 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
...
<section id="optimal" class="whiteback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение Вконтакте</h3>
                <h4 class="section-title-h4">Пакет "Оптимальный"</h4>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/vkoptimal.jpg">
            </div>
            <div class="col-md-6">
                <p>
                <h4>Что входит в пакет?</h4>
                <ul class="ul-list">
                    ...
                    <li>Организация и проведение розыгрышей, конкурсов и опросов в группах.</li>
                    <li>Привлечение целевой аудитории, увеличение количества подписчиков, посетителей, участников групп.</li>
                    <li>Мониторинг отзывов о товарах компании, ответы на вопросы.</li>
                    <li>Анализ эффективности рекламных кампаний.</li>
                    <li>Анализ smm-активности конкурентов.</li>
                    <li>Подготовка аналитических отчетов.</li>
                </ul>
                </p>
                <p class="section-price">10 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
</section>
<section id="maximum" class="grayback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Продвижение Вконтакте</h3>
                <h4 class="section-title-h4">Пакет "Максимум"</h4>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/vkmaximum.jpg">
            </div>
            <div class="col-md-6">
                <p>
                <h4>Что входит в пакет?</h4>
                <ul class="ul-list hidetext">
                    <li>Развитие корпоративных аккаунтов в социальных сетях.</li>
                    <li>Эффективное присутствие компании в социальных сетях. Создание положительного имиджа компании в интернете. Увеличение количества посетителей, подписчиков, участников групп.</li>
                    <li>Анализ целевой аудитории бренда. Разработка и реализация стратегии и тактики присутствия бренда в социальных сетях. Ведение группы и поддержание ее активности.</li>
                    <li>Мониторинг упоминаний о бренде, лайках и репостах в соц сетях. Подключение всех нужных функций в группе для работы с клиентами (приложения)</li>
                    <li>Создание, подборка и оформление уникального и интересного контента.</li>
                    <li>Анализ и прогноз бюджета на рекламу</li>
                    <li>Ответы на вопросы участников группы, переадресация их на менеджеров компании.</li>
                    <li>Сбор людей в подписки, рассылка новостей и акций компании</li>
                    <li>Посев в тематических группах</li>
                    <li>Чистка от спама и нарушающих правила сообщений. Проведение розыгрышей.</li>
                    <li>Привлечение аудитории, размещение рекламы ВКонтакте (списки по парсингу, группы конкурентов). Работа с биржами сообществ.</li>
                    <li>Анализ эффективности, подготовка отчетов для клиента.</li>
                </ul>
                </p>
                <p class="section-price">20 000 руб./месяц</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
</section>
<section id="direct" class="whiteback wow fadeInUp" data-wow-delay="300ms">
    <!-- change the image in style.css to the class .number .container-fluid [approximately row 102] -->
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h3 class="section-title-h3">Живые участники в группу ВК</h3>
            </div>
            <div class="col-md-6 block-thumb">
                <img src="/images/vklive.jpg">
            </div>
            <div class="col-md-6">
                <p>
                    ?НОВИНКА!<br>
                    ?Услуга подходит только для ГРУПП! Для пабликов нет такой возможности.<br>
                    ?Cтоимость: 2,2 руб за 1 вступившего. Минимальный заказ 1 тыс.участников (2200 руб).<br>
                    ?Доступны критерии: по стране (Россия) и полу (муж или жен! По городу таргетинга нет.<br>

                    ?Подходит для групп специфика которых распространяется по всей России или для увеличения участников с целью поднятия в поисковике ВК.<br>

                    Принцип работы заключается в том, что высылаются приглашения вступить в группу заказчика живым людям, далее приглашенный человек самостоятельно принимает решение подписываться или нет.<br>

                    Скорость на прямую зависит от тематики сообщества и от размеров заказа (обычно от 50 до 500 вступивших в сутки). Кроме это есть зависимость от тематики: например 1000 человек в группу с тематикой "аренда тяжелой техники" будет набираться значительно дольше, чем в группу с тематикой "юмор".<br>

                    Есть запрещенные тематики добавляемых групп: Группы содержащие материалы 18+; продажа аккаунтов, группы без аватарки и без контента, алкоголь.
                </p>
                <p class="section-price">2 200 руб./1 тыс. человек</p>
                <a href="#iw-modal" class="btn btn-danger iw-modal-btn">ЗАКАЗАТЬ</a>
            </div>
        </div>
    </div>
